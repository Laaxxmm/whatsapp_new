      ...
      {show && (
        <span
          ...
          style={{
            ...
            background: '#15132b', color: '#fff', fontFamily: FONT, fontSize: 11.5, lineHeight: 1.45,
        ...
        >
          {text}
          <span style={{ position: 'absolute', top: '100%', left: '50%', transform: 'translateX(-50%)', borderWidth: 5, borderStyle: 'solid', borderColor: '#15132b transparent transparent transparent' }} />
        </span>
      )}
    </span>
  );
